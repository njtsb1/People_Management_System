...
function initDefaults(){
  ...
  if(!state.people || state.people.length === 0){
    state.people = [
      ...
      {id: uid(), name: "Alexandre Silva Lima, aka 'Gordão'", email: "alexandreslima.@example.com", organization: "Schoolmate Poet", year: 2006},
      {id: uid(), name: "Arivil", email: "arivil.@example.com", organization: "Schoolmate Poet", year: 2006},
      {id: uid(), name: "Bruno Vieira de Santana, aka 'Repolho'", email: "brunovsantana.@example.com", organization: "Schoolmate Poet", year: 2006},
      {id: uid(), name: "Fernando", email: "fernando.@example.com", organization: "Schoolmate Poet", year: 2006},
      {id: uid(), name: "José Augusto", email: "joseaugusto.@example.com", organization: "Schoolmate Poet", year: 2006},
      {id: uid(), name: "Luan Bernardo, aka 'Bilu'", email: "luanbernardo.@example.com", organization: "Schoolmate Poet", year: 2006},
